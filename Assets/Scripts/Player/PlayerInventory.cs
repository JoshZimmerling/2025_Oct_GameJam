...
public class PlayerInventory : MonoBehaviour
{
    ...
    public void SetupStartingInventory()
    {
        ...
        equippedItems = new List<CraftableItem>
        {
            ...
            new SpellItem("Secondary Spell", "Desc.\n\nDMG: 5\nRANGE: LONG\nCOOLDOWN: 1.5s\nPIERCING: NO", new Dictionary<FishType, int>(), ItemType.SECONDARY_ACTIVE_SPELL, "", "MeteorSpell"),
            new SpellItem("Healing Spell", "Recovers a bit of health every so often.\n\nHEALING: 5\nCOOLDOWN: 20s", new Dictionary<FishType, int>(), ItemType.PASSIVE_SPELL, "", "HealSpell"),

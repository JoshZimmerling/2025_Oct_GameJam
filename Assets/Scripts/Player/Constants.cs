...
public class Constants
{
    ...
    public static List<CraftableItem> AllCraftableItems = new List<CraftableItem> { 
        ...
        //FISHING ROD SHAFTS
        new FishingRodShaft("Simple Shaft", "A basic piece of hardware to get you going.\n\nFish Type: ALL\nChance to Multiply: 10%\nMutiplier Amount: 2x", new Dictionary<FishType, int> { { FishType.WOOD_FISH, 3 }, { FishType.STONE_FISH, 3 }, { FishType.IRON_FISH, 3 } }, ItemType.FISHING_ROD_SHAFT, "shaft_simple", new List<FishType> { FishType.WOOD_FISH, FishType.STONE_FISH, FishType.BRONZE_FISH, FishType.IRON_FISH, FishType.SILVER_FISH, FishType.GOLD_FISH, FishType.DIAMOND_FISH, FishType.SAPPHIRE_FISH, FishType.EMERALD_FISH, FishType.RUBY_FISH, FishType.STRING_FISH}, 10, 2),
        new FishingRodShaft("Wood Shaft", "High performance for those woody fellas.\n\nFish Type: WOOD\nChance to Multiply: 50%\nMutiplier Amount: 2x", new Dictionary<FishType, int> { { FishType.WOOD_FISH, 8 }, { FishType.IRON_FISH, 2 } }, ItemType.FISHING_ROD_SHAFT, "shaft_wood", new List<FishType> { FishType.WOOD_FISH }, 50, 2),
        new FishingRodShaft("Hard Shaft", "Rock solid.\n\nFish Type: STONE\nChance to Multiply: 50%\nMutiplier Amount: 2x", new Dictionary<FishType, int> { { FishType.STONE_FISH, 8 }, { FishType.BRONZE_FISH, 2 } }, ItemType.FISHING_ROD_SHAFT, "shaft_hard", new List<FishType> { FishType.STONE_FISH }, 50, 2),
        new FishingRodShaft("Metal Shaft", "Make Carnegie proud.\n\nFish Type: BRONZE + IRON\nChance to Multiply: 50%\nMutiplier Amount: 2x", new Dictionary<FishType, int> { { FishType.STONE_FISH, 5 }, { FishType.BRONZE_FISH, 5 }, { FishType.IRON_FISH, 5 } }, ItemType.FISHING_ROD_SHAFT, "shaft_metal", new List<FishType> { FishType.BRONZE_FISH, FishType.IRON_FISH }, 50, 2),
        new FishingRodShaft("Advanced Shaft", "The good stuff.\n\nFish Type: ALL\nChance to Multiply: 20%\nMutiplier Amount: 2x", new Dictionary<FishType, int> { { FishType.BRONZE_FISH, 3 }, { FishType.IRON_FISH, 3 }, { FishType.GOLD_FISH, 3 } }, ItemType.FISHING_ROD_SHAFT, "shaft_advanced", new List<FishType> { FishType.WOOD_FISH, FishType.STONE_FISH, FishType.BRONZE_FISH, FishType.IRON_FISH, FishType.SILVER_FISH, FishType.GOLD_FISH, FishType.DIAMOND_FISH, FishType.SAPPHIRE_FISH, FishType.EMERALD_FISH, FishType.RUBY_FISH, FishType.STRING_FISH}, 20, 2),
        new FishingRodShaft("Gambler's Shaft", "Greed is good.\n\nFish Type: ALL\nChance to Multiply: 10%\nMutiplier Amount: 3x", new Dictionary<FishType, int> { { FishType.WOOD_FISH, 5 }, { FishType.GOLD_FISH, 5 } }, ItemType.FISHING_ROD_SHAFT, "shaft_gamblers", new List<FishType> { FishType.WOOD_FISH, FishType.STONE_FISH, FishType.BRONZE_FISH, FishType.IRON_FISH, FishType.SILVER_FISH, FishType.GOLD_FISH, FishType.DIAMOND_FISH, FishType.SAPPHIRE_FISH, FishType.EMERALD_FISH, FishType.RUBY_FISH, FishType.STRING_FISH}, 10, 3),
        ...
        new FishingRodShaft("Complex Shaft", "Big brain fish gain.\n\nFish Type: ALL\nChance to Multiply: 30%\nMutiplier Amount: 2x", new Dictionary<FishType, int> { { FishType.SILVER_FISH, 3 }, { FishType.GOLD_FISH, 3 }, { FishType.DIAMOND_FISH, 3 } }, ItemType.FISHING_ROD_SHAFT, "shaft_complex", new List<FishType> { FishType.WOOD_FISH, FishType.STONE_FISH, FishType.BRONZE_FISH, FishType.IRON_FISH, FishType.SILVER_FISH, FishType.GOLD_FISH, FishType.DIAMOND_FISH, FishType.SAPPHIRE_FISH, FishType.EMERALD_FISH, FishType.RUBY_FISH, FishType.STRING_FISH}, 30, 2),
        new FishingRodShaft("Treasure Shaft", "Bling that thing.\n\nFish Type: SAPPHIRE + EMERALD + RUBY\nChance to Multiply: 50%\nMutiplier Amount: 2x", new Dictionary<FishType, int> { { FishType.SAPPHIRE_FISH, 2 }, { FishType.EMERALD_FISH, 2 }, { FishType.RUBY_FISH, 2 } }, ItemType.FISHING_ROD_SHAFT, "shaft_treasure", new List<FishType> { FishType.SAPPHIRE_FISH, FishType.EMERALD_FISH, FishType.RUBY_FISH }, 50, 2),
        //FISHING ROD BAIT
        ...
        new FishingRodBait("Magnet", "Metal attracts metal.\n\nFish Type: IRON\nFind Chance Increase: 1.5x", new Dictionary<FishType, int> { { FishType.WOOD_FISH, 5 }, { FishType.IRON_FISH, 5 } }, ItemType.FISHING_ROD_BAIT, "bait_magnet", new List<FishType> { FishType.IRON_FISH }, 1.5f),
        new FishingRodBait("Medal", "Fresh off the podium.\n\nFish Type: BRONZE + SILVER + GOLD\nFind Chance Increase: 1.333x", new Dictionary<FishType, int> { { FishType.WOOD_FISH, 10 }, { FishType.STONE_FISH, 20 } }, ItemType.FISHING_ROD_BAIT, "bait_medal", new List<FishType> { FishType.BRONZE_FISH, FishType.SILVER_FISH, FishType.GOLD_FISH }, 1.333f),
        new FishingRodBait("Shiny Magnet", "Gold plated for extra attraction.\n\nFish Type: IRON + GOLD\nFind Chance Increase: 1.75x", new Dictionary<FishType, int> { { FishType.IRON_FISH, 15 }, { FishType.GOLD_FISH, 5 } }, ItemType.FISHING_ROD_BAIT, "bait_shiny_magnet", new List<FishType> { FishType.IRON_FISH, FishType.GOLD_FISH }, 1.75f),
        ...
        new WandItem("Wand of Swiftness", "A simple speedy spell slinger.\n\nDMG MOD: 0.75x\nSIZE MOD: 0.75x\nRANGE MOD: 1.2x\nCD MOD: 0.5x", new Dictionary<FishType, int> { { FishType.STONE_FISH, 8 }, { FishType.IRON_FISH, 3 }, { FishType.SAPPHIRE_FISH, 1} }, ItemType.WAND, "", 0.75f, 0.75f, 1.2f, 0.5f),

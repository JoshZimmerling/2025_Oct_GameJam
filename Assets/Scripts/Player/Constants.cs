...
public class Constants
{
    ...
    public static List<CraftableItem> AllCraftableItems = new List<CraftableItem> { 
        ...
        //WAND
        new WandItem("Wand of the Novice", "A beginners wand to teach you the basics.\n\nDMG MOD: 1x\nSIZE MOD: 1.5x\nRANGE MOD: 1x\nCD MOD: 1x", new Dictionary<FishType, int> { { FishType.WOOD_FISH, 4 }, { FishType.STONE_FISH, 3 }, { FishType.BRONZE_FISH, 2 } }, ItemType.WAND, "wand_wand_of_the_novice", 1f, 1.5f, 1f, 1f),
        new WandItem("Apprentice's Wand", "To be given to all apprentices on their first day.\n\nDMG MOD: 1x\nSIZE MOD: 1x\nRANGE MOD: 1.5x\nCD MOD: 1x", new Dictionary<FishType, int> { { FishType.WOOD_FISH, 5 }, { FishType.BRONZE_FISH, 1 }, { FishType.IRON_FISH, 1 } }, ItemType.WAND, "wand_apprentices_wand", 1f, 1f, 1.5f, 1f),
        ...
        new WandItem("Merlin's* Wand", "*Not that Merlin but, a Merlin?\n\nDMG MOD: 1.2x\nSIZE MOD: 1.2x\nRANGE MOD: 1.2x\nCD MOD: 1.5x", new Dictionary<FishType, int> { { FishType.WOOD_FISH, 12 }, { FishType.STONE_FISH, 6 } }, ItemType.WAND, "wand_merlins_wand", 1.2f, 1.2f, 1.2f, 1.5f),
        new WandItem("Wand of Swiftness", "A simple speedy spell slinger.\n\nDMG MOD: 0.75x\nSIZE MOD: 0.75x\nRANGE MOD: 1.2x\nCD MOD: 0.5x", new Dictionary<FishType, int> { { FishType.STONE_FISH, 8 }, { FishType.IRON_FISH, 2 }, { FishType.SAPPHIRE_FISH, 1} }, ItemType.WAND, "wand_wand_of_swiftness", 0.75f, 0.75f, 1.2f, 0.5f),
        new WandItem("Pocket Wand", "You’ve heard of a pocket knife.\n\nDMG MOD: 2.5x\nSIZE MOD: 0.5x\nRANGE MOD: 0.5x\nCD MOD: 1x", new Dictionary<FishType, int> { { FishType.IRON_FISH, 15 }, { FishType.SILVER_FISH, 10 } }, ItemType.WAND, "wand_pocket_wand", 2.5f, 0.5f, 0.5f, 1f),
        new WandItem("Large Caliber Wand", "Steady...\n\nDMG MOD: 2x\nSIZE MOD: 1.25x\nRANGE MOD: 2x\nCD MOD: 2x", new Dictionary<FishType, int> { { FishType.STONE_FISH, 15 }, { FishType.BRONZE_FISH, 10 }, { FishType.GOLD_FISH, 3 } }, ItemType.WAND, "wand_large_caliber_wand", 2f, 1.25f, 2f, 2f),
        new WandItem("Wand of the Mage", "A professional’s choice.\n\nDMG MOD: 1.25x\nSIZE MOD: 1.25x\nRANGE MOD: 1.25x\nCD MOD: 0.75x", new Dictionary<FishType, int> { { FishType.WOOD_FISH, 30 }, { FishType.EMERALD_FISH, 1 } }, ItemType.WAND, "wand_wand_of_the_mage", 1.25f, 1.25f, 1.25f, .75f),
        new WandItem("Rapid Fire Wand", "So anyways I started blasting.\n\nDMG MOD: 0.5x\nSIZE MOD: 1x\nRANGE MOD: 1x\nCD MOD: 0.2x", new Dictionary<FishType, int> { { FishType.SILVER_FISH, 15 }, { FishType.GOLD_FISH, 10 } }, ItemType.WAND, "wand_rapid_fire_wand", 0.5f, 1f, 1f, .2f),
        new WandItem("Wand of the Wizard", "For once you have truly mastered casting spells.\n\nDMG MOD: 1.4x\nSIZE MOD: 1.4x\nRANGE MOD: 1.4x\nCD MOD: 0.7x", new Dictionary<FishType, int> { { FishType.IRON_FISH, 10 }, { FishType.GOLD_FISH, 5 }, { FishType.RUBY_FISH, 1 } }, ItemType.WAND, "wand_wand_of_the_wizard", 1.4f, 1.4f, 1.4f, .7f),
        //PRIMARY ACTIVE SPELL
        new SpellItem("Lightning Spell", "Fire a blast of lightning towards your target, dealing good damage across multiple enemies.\n\nDMG: 3\nRANGE: SHORT\nCOOLDOWN: 0.5s\nPIERCING: YES", new Dictionary<FishType, int> { { FishType.BRONZE_FISH, 4 }, { FishType.IRON_FISH, 1 } }, ItemType.PRIMARY_ACTIVE_SPELL, "spell_primary_lightning", "LightningSpell"),
        new SpellItem("Light Beam Spell", "Quickly shoot a beam of light towards your target, piercing through all enemies hit.\n\nDMG: 1\nRANGE: MEDIUM\nCOOLDOWN: 0.33s\nPIERCING: YES", new Dictionary<FishType, int> { { FishType.WOOD_FISH, 4 }, { FishType.STONE_FISH, 6 }, { FishType.BRONZE_FISH, 2 } }, ItemType.PRIMARY_ACTIVE_SPELL, "spell_primary_light_beam", "LightBeamSpell"),
        ...
        new SpellItem("Pulse Spell", "Emit a damaging aura around you dealing damage to all nearby enemies.\n\nDMG: 5\nRANGE: VERY SHORT\nCOOLDOWN: 0.4s\nPIERCING: YES", new Dictionary<FishType, int> { { FishType.STONE_FISH, 10 }, { FishType.IRON_FISH, 7 }, { FishType.SILVER_FISH, 5 } }, ItemType.PRIMARY_ACTIVE_SPELL, "spell_primary_pulse", "PulseSpell"),
        new SpellItem("Boomerang Spell", "Less of a spell and more of a heave, this projectile does damage on the way out and back from the player.\n\nDMG: 2x2\nRANGE: LONG\nCOOLDOWN: 1s\nPIERCING: YES", new Dictionary<FishType, int> { { FishType.WOOD_FISH, 20 }, { FishType.SILVER_FISH, 4 }, { FishType.EMERALD_FISH, 1 } }, ItemType.PRIMARY_ACTIVE_SPELL, "spell_primary_boomerang", "BoomerangSpell"),
        new SpellItem("Tornado Spell", "Summon a tornado that continuously deals damage every 0.5 seconds. While it persists, you can recast the spell to move the tornado's location.\n\nDMG: 2\nRANGE: LONG\nCOOLDOWN: 6s\nPIERCING: YES", new Dictionary<FishType, int> { { FishType.BRONZE_FISH, 15 }, { FishType.GOLD_FISH, 3 }, { FishType.SAPPHIRE_FISH, 1 } }, ItemType.PRIMARY_ACTIVE_SPELL, "spell_primary_tornado", "TornadoSpell"),
        new SpellItem("Boomstick Spell", "No more wands needed, it's time for the big guns.\n\nDMG: 15\nRANGE: VERY LONG\nCOOLDOWN: 2.25s\nPIERCING: NO", new Dictionary<FishType, int> { { FishType.SILVER_FISH, 15 }, { FishType.GOLD_FISH, 10 }, { FishType.DIAMOND_FISH, 3 } }, ItemType.PRIMARY_ACTIVE_SPELL, "spell_primary_boomstick", "BoomstickSpell"),
        //SECONDARY ACTIVE SPELL
        new SpellItem("Meteor Spell", "Call down a large meteor that does damage in an area around the cast location.\n\nDMG: 10\nRANGE: LONG\nCOOLDOWN: 15s\nPIERCING: YES", new Dictionary<FishType, int> { { FishType.STONE_FISH, 15 } }, ItemType.SECONDARY_ACTIVE_SPELL, "spell_secondary_meteor", "MeteorSpell"),
        new SpellItem("Spell of the Shallows", "Summon a whirlpool at the target location that does damage to all enemies inside of it every second, as well as briefly slowing them.\n\nDMG: 4/s\nRANGE: VERY LONG\nCOOLDOWN: 10s\nPIERCING: YES", new Dictionary<FishType, int> { { FishType.WOOD_FISH, 5 }, { FishType.BRONZE_FISH, 5 }, { FishType.SAPPHIRE_FISH, 1 } }, ItemType.SECONDARY_ACTIVE_SPELL, "spell_secondary_shallows", "SpellOfTheShallows"),
        new SpellItem("Icicle Spell", "Launch an icicle at the cursor that prevents the first enemy hit from moving for the next few seconds.\n\nDMG: 0\nRANGE: VERY LONG\nCOOLDOWN: 10s\nPIERCING: NO", new Dictionary<FishType, int> { { FishType.IRON_FISH, 10 }, { FishType.SILVER_FISH, 5 } }, ItemType.SECONDARY_ACTIVE_SPELL, "spell_secondary_icicle", "IcicleSpell"),
        new SpellItem("Spell of the Spirits", "Fire a spiritual grasp towards your cursor, grabbing and pulling the first enemy hit towards you, and stunning them briefly.\n\nDMG: 0\nRANGE: VERY LONG\nCOOLDOWN: 15s\nPIERCING: NO", new Dictionary<FishType, int> { { FishType.BRONZE_FISH, 15 }, { FishType.GOLD_FISH, 3 }, { FishType.EMERALD_FISH, 1 } }, ItemType.SECONDARY_ACTIVE_SPELL, "spell_secondary_spell_of_the_spirits", "SpellOfTheSpirits"),
        //PASSIVE SPELL
        new SpellItem("Spell of Swiftness", "Occasionally grants a small burst of movement speed.\n\nSPEED: +20%\nDURATION: 5s\nCOOLDOWN: 20s", new Dictionary<FishType, int> { { FishType.BRONZE_FISH, 5 } }, ItemType.PASSIVE_SPELL, "spell_passive_speed", "SpeedSpell"),
        new SpellItem("Spike Ring Spell", "Spawn in a ring of spikes a set distance away from you that deal damage and slow the first enemy to touch them.\n\nDAMAGE: 4\nLIFESPAN: 8s\nCOOLDOWN: 25s", new Dictionary<FishType, int> { { FishType.WOOD_FISH, 8 }, { FishType.STONE_FISH, 5 }, { FishType.IRON_FISH, 2 }, { FishType.SAPPHIRE_FISH, 1 } }, ItemType.PASSIVE_SPELL, "spell_passive_spike", "SpikeRingSpell"),
        new SpellItem("Detection Spell", "Fire a weak projectile at the nearest detected enemy.\n\nDAMAGE: 1\nRANGE: LONG\nCOOLDOWN: 3s", new Dictionary<FishType, int> { { FishType.WOOD_FISH, 10 }, { FishType.IRON_FISH, 5 }, { FishType.SILVER_FISH, 5 }, { FishType.EMERALD_FISH, 1 } }, ItemType.PASSIVE_SPELL, "spell_passive_detection", "DetectionSpell"),
    };
